    ...
    private static class PropertySetter {
        ...
        public void SetProperty(XSSFRow row, Book book) {
            ...
            try {
                ...
                LOGGER.error("Id Cell. Key: {}, Row num: {}, ISBN: {}", key, book.getIsbn(), e.getMessage());
            }
            ...
            try {
                ...
                LOGGER.error("Value Cell. Key: {}, Row num: {}, ISBN: {}", key, book.getIsbn(), e.getMessage());
            }
            ...
            try {
                ...
                LOGGER.error("BW Cell. Key: {}, Row num: {}, ISBN: {}", key, book.getIsbn(), e.getMessage());
            }
        }
